...
def extract():
    ...
    relation_groups = {str(relation): group[[2, 3]] for relation, group in assertions.groupby(1)}
    np.savez_compressed('data.npz', relations=relations, concepts=concepts, **relation_groups)
